...
<section class="konten">
  <div class="container">
    ...
    if (isset($_POST["checkout"])) {
      ...
      $ambil = $koneksi->query("INSERT INTO pembelian (id_pelanggan, tanggal_pembelian,total_pembelian,mode_bayar,alamat_pengiriman) VALUE ('$id_pelanggan','$tanggal_pembelian','$totalbelanja','$mode_bayar','$alamat_pengiriman')");
